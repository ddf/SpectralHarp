...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SpectralHarp Demo Installer\n"
      else:
        line="OutputBaseFilename=SpectralHarp Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SpectralHarp Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SpectralHarp installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SpectralHarp Demo installer\n"
     else:
       line="SetupWindowTitle=SpectralHarp installer\n"
