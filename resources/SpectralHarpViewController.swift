/*
  This is the initial ios app extension view controller, which is referenced by SpectralHarp-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class SpectralHarpViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in SpectralHarp-iOS-MainInterface.storyboard to custom class: GenericUI  module: SpectralHarpFramework
